            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="basquet.php">Basket</a>&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
...
//Crear select con curdate para que aparezcan  los de hoy y proximos
                        ...
                        $query="SELECT DISTINCT Categoria from InfoApuestas WHERE Esport = 'Basket' AND DataHora > CURRENT_TIMESTAMP()";
                        $db -> query($query);
                        $id_res = $db->query($query);
                        echo "<form class='form-horizontal' role='form' enctype='multipart/form-data' name='lista' action='basquet.php' method='POST'>";
