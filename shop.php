                ...
                <ul id="side-menu" class="nav">
                    ...
                    <li ><a href="eventos.php"><i class="fa fa-flag-checkered fa-fw">
                      ...
                      <ul class="nav nav-pills nav-stacked";>
                        ...
                        <span class="menu-title ">Futbol</span></a></li>
                      </ul>
                      <ul  class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="shop.php"><i class="fa fa-shopping-cart fa-fw">
                        <div class="icon-bg bg-blue"></div>
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="shop.php">Tienda</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                    ...
                    <div id="tab-general">
                        <?php
                            ...
                            while($fila = mysqli_fetch_array($id_res)){  
                                echo '<div class="item col-xs-12 col-md-6 col-lg-4">
                                        <div class="thumbnail">
                                            <img class="group list-group-image" src="images/gallery/'.$fila["nom"].'.png" alt="" />
                                                <div class="caption">';
                                                    echo '<h4 class="group inner list-group-item-heading">';
                                                    echo "<form name='comprar' action='change.php' method='POST'>";
                                                    echo $fila["nom"]."</h4>";
                                                    echo '<p class="">';
                                                    echo $fila["descripcio"].'</p><br>';
                                                    echo '<input type="hidden" name="product" value='.$fila["id_Producto"].'>';
                                                    echo '<div class="row">
                                                        <div class="col-xs-12 col-md-6 col-lg-12">
                                                    
                                                        <p class="lead">'.$fila["cost"].' € <br> Bonificación: '.$fila["addcoins"].'<img style="width:30px" src="images/gallery/gold.png"></p><input name="boton" type="submit" class="btn btn-success" value="Comprar"></form> ';
