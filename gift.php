        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="gift.php"><i class="fa fa-gift fa-fw">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="#">Premios</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        ...
                        $user =$_SESSION["mail"];
                            ...
                            while($fila = mysqli_fetch_array($id_res)){  
                                echo '<div class="item  col-xs-12 col-md-6 col-lg-4">
                                        <div class="thumbnail">
                                            <img class="group list-group-image" src="images/gallery/'.$fila["nom"].'.jpg" alt="" />
                                                <div class="caption">';
                                                echo "<form name='comprar' action='getitem.php' method='POST'>";
                                                    echo '<h4 class="group inner list-group-item-heading">';
                                                    echo $fila["nom"]."</h4>";
                                                    echo '<input type="hidden" name="premio" value='.$fila["id_premi"].'>';
                                                    echo '<p class="">';
                                                    echo $fila["descripcio"].'</p><br>';
                                                    echo '<div class="row">
                                                        <div class="col-xs-12 col-md-6 col-lg-10">
                                                        <p class="lead">'.$fila["cost"].' Coins</p>';
                                                    if ($fila["cost"] > $coins){
                                                    echo '<input name="boton" type="button" class="btn btn-warning" value="Coins insuficientes"></form> ';    
                                                    }else{
                                                    echo '<input name="boton" type="submit" class="btn btn-success" value="Comprar">'; } echo '</form> ';
