        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="calendario.php"><i class="fa fa-calendar fa-fw">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="futbol.php">Calendario</a>&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                    ...
                    <div id="tab-general">
                      <?php
                            if (isset($_POST['Apostar'])){
                                $evento = $_POST['evento'];
                                echo "<form action='odds.php' method='post'><input type='hidden' value=".$evento."></form>";
                                ?><script>window.location('odds.php')</script><?php   
                            }
//Crear select con curdate para que aparezcan  los de hoy y proximos
                            $query= "SELECT * from InfoApuestas WHERE DataHora > CURRENT_TIMESTAMP() ORDER BY DataHora ASC";
                            $id_res = mysqli_query($db,$query);
                            echo "<h3>Futuros Eventos</h3>";
                            echo '<div class="  "><div class="row">';
                            while($row = mysqli_fetch_array($id_res)){
                                $evento= $row["id_apuesta"];
                                echo '<div id="sum_box" class="">';
                                ...
                                echo '<div class="text-center"><img src="images/gallery/'.$row["Esport"].'.png" style="width:6%;"></div><br>';
                                echo "<p class='m-b-0'>Deporte - <b>".$row["Esport"]."</b></p><p class='m-b-0'>Local - <b>".$row["Local"]."</b></p>";
                                echo "
                                    ...
                                    <div class='text-center'><input type='submit' class='btn btn-primary btn-lg' value='Acceder al evento'></div>
                                     </form>";
