...
?>
        ...
        <div class="col-md-12">
            <div class="well well-sm">
                <form name="contactito" action="contacto.php" method="POST">
                    <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Introduce tu nombre" required="required" /></div>
                        </div>
                        <div class="form-group">
                            <label for="email">
                        ...
                        <div class="form-group">
                            ...
                            <select id="subject" name="subject" class="form-control" required="required">
                                ...
                                <option value="No puedo acceder a mi cuenta">No puedo acceder a mi cuenta</option>
                                <option value="Me han desaparecido coins">Me han desaparecido coins</option>
                                <option value="No me llega un producto">No me llega un producto</option>
                    ...
                    <div class="col-md-12">
                        <button type="submit" name="contactar" class="btn btn-primary pull-right" id="btnContactUs">
                            Enviar</button>
                    </div>
                </div>
                </form>
