            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="tennis.php">Tennis</a>&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
...
//Crear select con curdate para que aparezcan  los de hoy y proximos
                        ...
                        $query="SELECT DISTINCT Categoria from InfoApuestas WHERE Esport = 'Tennis' AND DataHora > CURRENT_TIMESTAMP()";
                        $db -> query($query);
                        $id_res = $db->query($query);
                        echo "<form class='form-horizontal' role='form' enctype='multipart/form-data' name='lista' action='tennis.php' method='POST'>";
